...
export const Route = createFileRoute("/_app/fairness")({
  ...
  head: () => ({ meta: [{ title: "Fairness Report · Nyrova" }] }),
});
...
function downloadFairnessPdf() {
  try {
    ...
    doc.setFontSize(18);
    doc.text("Nyrova — AI Fairness & Bias Report", 32, 32);
    doc.setFontSize(10);
    ...
    doc.save(`Nyrova-Fairness-Report-${new Date().toISOString().slice(0, 10)}.pdf`);
